...
data_list = [
{"country":"usa", "state":"olorona", "name":"ariyana"},
{"country":"usa", "state":"missouri", "name":"michelle"}, 
{'country':"india", 'state':"co", 'name':"ariyana"},{'country':"india", 'state':"chennai", 'name':"deag"},
]
def function(k):
	return k['country']
